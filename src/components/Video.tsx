...
export const Video = () => {
  return (
    <div className="w-full relative h-screen">
      ...
      <video style={{ clipPath: "polygon(0 0, 100% 0, 100% 85%, 50% 100%, 50% 100%, 0 85%)" }} className="w-full object-cover object-top h-full" src="/videos/video1.mp4" autoPlay muted loop></video>
